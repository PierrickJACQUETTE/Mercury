...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pw6_formation.antispam' => 'getPw6Formation_AntispamService',
            ...
            'security.user.provider.concrete.bdd' => 'getSecurity_User_Provider_Concrete_BddService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mercury', 'user' => 'root', 'password' => 'azerty', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/PW6/FormationBundle/Entity'), 1 => ($this->targetDirs[3].'/src/PW6/RecrutementBundle/Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/PW6/UserBundle/Resources/config/doctrine') => 'PW6\\UserBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'PW6\\FormationBundle\\Entity');
        $d->addDriver($b, 'PW6\\RecrutementBundle\\Entity');
        $d->addDriver($c, 'PW6\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('PW6FormationBundle' => 'PW6\\FormationBundle\\Entity', 'PW6UserBundle' => 'PW6\\UserBundle\\Entity', 'PW6RecrutementBundle' => 'PW6\\RecrutementBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4f5f5fbbdab68b9269a13fc3fdce1587b77668ef68efc645adf326709b97650c');
    ...
    /**
     * Gets the 'pw6_formation.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PW6\Antispam\PW6Antispam A PW6\Antispam\PW6Antispam instance.
     */
    protected function getPw6Formation_AntispamService()
    {
        return $this->services['pw6_formation.antispam'] = new \PW6\Antispam\PW6Antispam($this->get('swiftmailer.mailer.default'), 'en', 128);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'PW6\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/formation');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/view/');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/admin/');
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.bdd'), 1 => $k), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $l, 'main', $n, $o, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57399b92552b26.18775459', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, 'login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PW6/FormationBundle/Resources/views'), 'PW6Formation');
        $instance->addPath(($this->targetDirs[3].'/src/PW6/UserBundle/Resources/views'), 'PW6User');
        $instance->addPath(($this->targetDirs[3].'/src/PW6/RecrutementBundle/Resources/views'), 'PW6Recrutement');
        $instance->addPath(($this->targetDirs[3].'/src/PW6/StatistiqueBundle/Resources/views'), 'PW6Statistique');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1c0e19ee1a3d1f9f17afe005a13895c8bd8da336');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.bdd'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57399b92552b26.18775459')), true);
    ...
    /**
     * Gets the 'security.user.provider.concrete.bdd' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_BddService()
    {
        return $this->services['security.user.provider.concrete.bdd'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'PW6\\UserBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PW6FormationBundle' => 'PW6\\FormationBundle\\PW6FormationBundle',
                'PW6UserBundle' => 'PW6\\UserBundle\\PW6UserBundle',
                'PW6RecrutementBundle' => 'PW6\\RecrutementBundle\\PW6RecrutementBundle',
                'ObHighchartsBundle' => 'Ob\\HighchartsBundle\\ObHighchartsBundle',
                'PW6StatistiqueBundle' => 'PW6\\StatistiqueBundle\\PW6StatistiqueBundle',
            ...
            'secret' => '1c0e19ee1a3d1f9f17afe005a13895c8bd8da336',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1c0e19ee1a3d1f9f17afe005a13895c8bd8da336',
